...
Glede na raziskavo  pa naj bi bila specifična rotacija sintetičnega medu bila zaradi dodanih sladkorjev s pozitivno kiralnostjo v rangu: $[\alpha]_{med_s} = (7 - 89) \ \frac{^\circ \cdot \mathrm{dm}}{\mathrm{g} \cdot \mathrm{mL}}$
...
\fbox{
    \begin{minipage}{0.8\textwidth}
        ...
        \[
            \abserr{[\alpha]}{med_1}{-70}{87}{\frac{^\circ \cdot \mathrm{dm}}{\mathrm{g} \cdot \mathrm{mL}}}
        \]
        \[
            \relerr{[\alpha]}{med_1}{-70}{1.24}{\frac{^\circ \cdot \mathrm{dm}}{\mathrm{g} \cdot \mathrm{mL}}}
        \]
    \end{minipage}
}
\end{center}
